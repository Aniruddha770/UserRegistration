 ...
 * @Author Aniruddha
 * @since 29Jun2021
 * As a User need to enter a valid Password with minimum 8 Characters.
 */
...
public class UserRegistrationUC5 {static Scanner s= new Scanner(System.in);
    ...
    public static void main(String[] args) {
        ...
        String passwordregex= "^[A-Z][a-z]{7,}";
