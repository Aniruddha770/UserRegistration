 ...
 * @Author Aniruddha
 * @since 29Jun2021
 * As a User need to enter a valid Password with minimum 8 Characters and has exactly one Special character.
 */

import java.util.Scanner;
import java.util.regex.Pattern;

public class UserRegistrationUC8 { static Scanner s= new Scanner(System.in);
